...
web
"""
for lan in ssafy["language"].keys():
    print(lan)
...
a = ssafy["classes"]["seoul"]
for i in ("lecturer", "manager"):
    print(a[i])
...
# 방법 1
for name1, name2 in ssafy["language"]["python"]["frameworks"].items():
    print(f"{name1}은(는) {name2}이다.")


# 방법 2
for names in ssafy["language"]["python"]["frameworks"].items():
    print(f"{names[0]}은(는) {names[1]}이다.")
...
print("오늘의 당번은 " + choice(ssafy["classes"]["seoul"]["groups"]["A"]))